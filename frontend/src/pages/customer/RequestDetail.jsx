...
import { CreditCardIcon, CheckCircleIcon, TrashIcon } from '@heroicons/react/24/outline';
  ...
  return (
    <div className="max-w-2xl space-y-5 animate-fade-in-up">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            {(isCompleted || isCancelled) && (
              <button
                ...
                disabled={deleting}
                className="btn-danger ml-auto py-2 px-4 text-sm"
              >
                Delete Request
              </button>
            )}
      ...
      <RequestChat
        ...
        myRole="customer"
        otherName={tech?.name}
        isAssigned={!!request.technicianId}
      />
